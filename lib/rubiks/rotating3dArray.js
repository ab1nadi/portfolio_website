...
export function getSide(array, side)
{
    ...
    for(let z= 0; z<array.length; z++)
    {
        switch(side)
        {
            case 0:
                if(x==array.length-1)
                    arr.push(array[z][y][x]);
                else 
                other.push(array[z][y][x]);
            break;
            case 1:
                if(x==0)
                    arr.push(array[z][y][x]);
...
export function rotateSide(array, side, direction)
{
    switch (side)
    {
        ...
        //x
        case 0:
            rotateRight(array,!direction)
        break;
        case 1:
            rotateLeft(array,!direction)
        break;

        //y
        case 2:
            rotateFront(array,!direction)
        break;
        case 3:
            rotateBack(array,!direction)
        break;

        //z
        case 4:
            rotateTop(array,!direction)
        break;
        case 5:
            rotateBottom(array,!direction)
        break;
    }
}
