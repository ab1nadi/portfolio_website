...
export interface ApiCertificationCertification
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit_url: Schema.Attribute.String;
    current_job: Schema.Attribute.Boolean;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bullet_points: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
...
export interface ApiTypeWriterWordTypeWriterWord
  extends Struct.CollectionTypeSchema {
  collectionName: 'type_writer_words';
  info: {
    displayName: 'Type Writer Word';
    pluralName: 'type-writer-words';
    singularName: 'type-writer-word';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::type-writer-word.type-writer-word'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
